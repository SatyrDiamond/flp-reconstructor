...
FLP_Data = flpreconstructor.deconstruct(args.input)
...
#    print(FL_Channel, FL_Channels[FL_Channel])
...
flpreconstructor.reconstruct(FLP_Data, 'out.flp')
